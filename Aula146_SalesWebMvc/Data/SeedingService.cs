...
using Aula146_SalesWebMvc.Models.Enums;

namespace Aula146_SalesWebMvc.Data
{
    public class SeedingService
    {
        private Aula146_SalesWebMvcContext _context;

        // construtor
        public SeedingService (Aula146_SalesWebMvcContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            // testar se exite algum registro na tabela : Department ou Seller ou SalesRecord
            ...
            // inclusao dos objetos no banco de dados
